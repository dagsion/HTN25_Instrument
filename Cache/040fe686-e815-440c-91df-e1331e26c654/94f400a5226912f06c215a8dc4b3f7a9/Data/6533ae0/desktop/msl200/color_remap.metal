...
//sampler sampler screenTextureSmpSC 0:25
//texture texture2D intensityTexture 0:1:0:17
//texture texture2D sc_ScreenTexture 0:13:0:22
//texture texture2D screenTexture 0:16:0:25
//ubo float sc_BonesUBO 0:0:96 {
//sc_Bone_t sc_Bones 0:[1]:96
//float4 sc_Bones.boneMatrix 0:[3]:16
//float4 sc_Bones.normalMatrix 48:[3]:16
//}
//ubo int UserUniforms 0:26:4464 {
//float4 sc_Time 1376
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_screenTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_screenTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_screenTexture 36 0
...
//spec_const bool sc_VertexBlendingUseNormals 66 0
//spec_const bool sc_VertexBlending 67 0
//spec_const bool sc_Voxelization 68 0
//spec_const bool screenTextureHasSwappedViews 69 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 70 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_screenTexture 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_screenTexture 73 -1
...
//spec_const int screenTextureLayout 82 0
//SG_REFLECTION_END
...
constant bool SC_USE_CLAMP_TO_BORDER_screenTexture [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_screenTexture [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_screenTexture [[function_constant(36)]];
...
constant bool sc_VertexBlendingUseNormals [[function_constant(66)]];
constant bool sc_VertexBlendingUseNormals_tmp = is_function_constant_defined(sc_VertexBlendingUseNormals) ? sc_VertexBlendingUseNormals : false;
constant bool sc_VertexBlending [[function_constant(67)]];
constant bool sc_VertexBlending_tmp = is_function_constant_defined(sc_VertexBlending) ? sc_VertexBlending : false;
constant bool sc_Voxelization [[function_constant(68)]];
constant bool sc_Voxelization_tmp = is_function_constant_defined(sc_Voxelization) ? sc_Voxelization : false;
constant bool screenTextureHasSwappedViews [[function_constant(69)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_screenTexture [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_screenTexture [[function_constant(73)]];
...
constant int screenTextureLayout [[function_constant(82)]];
...
int l9_132=l9_131;
l9_130=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_132]*param_1.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_137=param_1.position;
...
float2 ScreenCoord_N2=float2(0.0);
ScreenCoord_N2=Globals.gScreenCoord;
...
int l9_19=l9_14;
int param=screenTextureLayout_tmp;
int param_1=l9_19;
float2 param_2=ScreenCoord_N2;
bool param_3=(int(SC_USE_UV_TRANSFORM_screenTexture_tmp)!=0);
float3x3 param_4=(*sc_set0.UserUniforms).screenTextureTransform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_screenTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTexture_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_screenTexture_tmp)!=0);
float4 param_7=(*sc_set0.UserUniforms).screenTextureUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_screenTexture_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).screenTextureBorderColor;
float param_10=0.0;
...
float3 l9_84=l9_83;
float3 l9_85=l9_84;
float4 l9_86=sc_set0.screenTexture.sample(sc_set0.screenTextureSmpSC,l9_85.xy,bias(l9_79));
float4 l9_87=l9_86;
if (param_8)
{
...
float4 param_11=(*sc_set0.UserUniforms).color3;
Output_N7=param_11;
float4 Output_N8=float4(0.0);
float4 param_12=(*sc_set0.UserUniforms).color4;
Output_N8=param_12;
float4 Output_N5=float4(0.0);
float4 param_13=(*sc_set0.UserUniforms).color1;
Output_N5=param_13;
float4 Output_N6=float4(0.0);
float4 param_14=(*sc_set0.UserUniforms).color2;
Output_N6=param_14;
float4 Output_N3=float4(0.0);
Output_N3=smoothstep(Output_N5,Output_N6,Color_N1);
float4 Output_N9=float4(0.0);
Output_N9=smoothstep(Output_N7,Output_N8,Output_N3);
float Output_N11=0.0;
float param_15=(*sc_set0.UserUniforms).alpha;
Output_N11=param_15;
float4 Output_N10=float4(0.0);
Output_N10=mix(Color_N1,Output_N9,float4(Output_N11));
FinalColor=Output_N10;
...
float2 l9_90=floor(mod(l9_89.xy,float2(4.0)));
float l9_91=(mod(dot(l9_90,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_16<l9_91)
{
discard_fragment();
}
...
float4 l9_141=l9_102;
float3 l9_142=l9_141.xyz;
float3 l9_143=l9_142;
float3 l9_144=l9_100.xyz;
...
l9_101=float4(l9_145.x,l9_145.y,l9_145.z,l9_101.w);
float3 l9_146=mix(l9_142,l9_101.xyz,float3(l9_100.w));
l9_101=float4(l9_146.x,l9_146.y,l9_146.z,l9_101.w);
l9_101.w=1.0;
float4 l9_147=l9_101;
param_17=l9_147;
}
else
{
...
float4 l9_159=param_20;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_159.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_159;
return out;
}
} // FRAGMENT SHADER
